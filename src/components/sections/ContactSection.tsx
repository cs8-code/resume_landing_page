  ...
  return (
    <section id="contact" className="py-40 px-4 relative">
      <div className="max-w-3xl mx-auto text-center animate-fade-in">
        ...
        <h3 className="text-6xl sm:text-7xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-blue-300 to-cyan-400 mb-8 tracking-tight drop-shadow-[0_0_30px_rgba(59,130,246,0.3)]">{contactContent.title}</h3>
