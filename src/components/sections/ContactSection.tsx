      ...
      <div className="max-w-3xl mx-auto text-center animate-fade-in">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
          ...
          <a
            ...
            className="group inline-block px-10 py-5 border-2 border-green-500 text-green-400 rounded-lg font-mono text-sm hover:bg-green-500/10 transition-all duration-300 hover:scale-105 hover:shadow-[0_0_30px_rgba(34,197,94,0.5)]"
          >
            <span className="inline-flex items-center gap-2">
              <svg 
                className="w-5 h-5" 
